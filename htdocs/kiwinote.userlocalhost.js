...
// @resource kiwicss http://127.0.0.1/kiwi/webclient/kiwicss.css
// ==/UserScript==
...
if (unsafeWindow.jQuery === undefined) { //if jquery is not loaded
  ...
  $( "<div></div>", {
    ...
    on: {
      click: function() {
        $('#iframeNew').attr("src", "http://127.0.0.1/kiwi/webclient/new.php?url="+currentURL+"&fullscreen=0");
        $('#noteList').hide();
        $('#overlay').show();
        $('#newNote').show();
          $('#noteListOpen').addClass('disabled').removeClass('enabled');
  ...
  $( "<img></img>", {
      "src": "http://127.0.0.1/kiwi/webclient/icons/new.png",
  ...
  $( "<div></div>", {
      ...
      on: {
        click: function() {
          $('#iframeList').attr("src", "http://127.0.0.1/kiwi/webclient/list.php?url="+currentURL+"&fullscreen=0");
          $('#newNote').hide();
          $('#overlay').show();
          $('#noteList').show();
  ...
  $( "<img></img>", {
      "src": "http://127.0.0.1/kiwi/webclient/icons/list.png",
  ...
  $( "<iframe></iframe>", {
    "src": "http://127.0.0.1/kiwi/webclient/list.php?url="+currentURL+"&fullscreen=0",
    "id": "iframeList",
    "frameborder": "0",
    "height": "461",
    "width": "300",
  ...
  $( "<iframe></iframe>", {
    "src": "http://127.0.0.1/kiwi/webclient/new.php?url="+currentURL+"&fullscreen=0",
    "id": "iframeNew",
    "frameborder": "0",
    "height": "461",
    "width": "300",
